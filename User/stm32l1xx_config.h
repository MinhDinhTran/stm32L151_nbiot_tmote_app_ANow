...
#define RADER_POWER_GPIOx				GPIOB
#define RADER_POWER_PIN					GPIO_PIN_3
#define RADER_POWER_RCC_GPIO_CLK_ENABLE()	__HAL_RCC_GPIOB_CLK_ENABLE()
#define RADER_POWER_RCC_GPIO_CLK_DISABLE()	__HAL_RCC_GPIOB_CLK_DISABLE()
...
#define RADERPOWER(n)	(n?HAL_GPIO_WritePin(RADER_POWER_GPIOx, RADER_POWER_PIN, GPIO_PIN_SET):HAL_GPIO_WritePin(RADER_POWER_GPIOx, RADER_POWER_PIN, GPIO_PIN_RESET))
